...
/*  Michael Johnson 	2020-10-11 */
/*  added main for userspace helper duty in pichardrv */

#include <stdio.h>
#include <math.h>
#include <stdlib.h>
//we implement lltoa by hand do we need stdlib?
#include <limits.h>

unsigned char get_byte(int id);
//prototype def cuz gcc is picky
...
unsigned char main(int argc, char *argv[])
{
	...
	unsigned char ret = get_byte(index);
	printf("Get_Byte: %i Value: %x \n", index, ret);
	return ret;
}
